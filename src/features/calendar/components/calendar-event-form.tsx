...
const textAreaClass =
  "min-h-24 w-full resize-none rounded-[var(--radius-action)] border border-[var(--border-subtle)] bg-[var(--surface-raised)] px-4 py-3 text-[12px] leading-5 text-[var(--text-primary)] outline-none transition focus:border-[var(--color-action-primary)]";
  ...
  return (
    ...
    >
      <form
        ...
        className="max-h-[calc(100vh-48px)] w-full max-w-[640px] overflow-y-auto rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--surface-content)] p-6 shadow-[var(--shadow-dialog)]"
        role="dialog"
        aria-modal="true"
